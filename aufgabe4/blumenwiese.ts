...
namespace L4_Canvas {
    ...
    function init(_event: Event): void {
        ...
        for (var i: number = 0; i < 15; i++) { //Insgesamt 15 Durchläufe -> 15 Blumen random generieren
            ...
            let _x: number = Math.floor(Math.random() * (570 - 150)) + 150; //Blumen werden auf einer Breite von 420px generiert. Vom rechten Rand zum linken Rand.
    ...
    //function drawSunflower(_x: number, _y: number, _strokeColor: string, _fillColor: string): void{  
    //Stängel
    //        crc2.beginPath();
    //        crc2.fillStyle = "#185A18";
    //        crc2.fillRect(_x, _y - 41, 6, 80);
    //        crc2.closePath();
    //        crc2.fill();
    //Blätter  
    //        crc2.fillStyle = "#337245";
    //        crc2.arc(_x + 0, _y + 5, 35, 0, 1.5);
    //        crc2.closePath();
    //        crc2.fill();
    //        crc2.beginPath();
    //        crc2.fillStyle = "#185A18";
    //        crc2.arc(_x + 32, _y + 36, 30, 3, -1.5);
    //        crc2.closePath();
    //        crc2.fill();
    //        crc2.beginPath();
    //        crc2.fillStyle = "#185A18";
    //        crc2.arc(_x - 22, _y + 30, 24, 4, 0.4);
    //        crc2.closePath();
    //        crc2.fill();
    //        crc2.beginPath();
    //        crc2.fillStyle = "#337245";
    //        crc2.arc(_x - 9, _y + 15, 26, 1, - 3);
    //        crc2.closePath();
    //        crc2.fill();
    //Blüte
    //        crc2.lineWidth = 1;
    ...
    //    
    //        crc2.beginPath();
    //        crc2.fillStyle = "#726D3F";  
    //        crc2.arc(_x + 2, _y - 48, 30, 0, 2 * Math.PI);
    //        crc2.closePath();
    //        crc2.fill() 
    //   }
